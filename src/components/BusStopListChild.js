...
const BusStopListChild = ({
  ...
  return (
    <List.Section style={styles.busStopCardBusSchedule}>
                ...
                style={{
                  backgroundColor:
                    busStopData.employees.findIndex(
                      ...
                      ? '#f5dd4b'
                      : index === 0 ? '#d7d9d9' : 'white',
                  marginBottom: 1,
                }}
                title={busStopData.name}
                right={props => {
                  return index !== busStopList.length - 1 &&
...
export default BusStopListChild;
